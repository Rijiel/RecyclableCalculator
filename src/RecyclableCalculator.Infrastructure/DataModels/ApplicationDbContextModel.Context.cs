...
namespace RecyclableCalculator.Infrastructure.DataModels
{
    ...
    public partial class ApplicationDbContextModelContainer : DbContext
    {
        public ApplicationDbContextModelContainer()
            : base("name=ApplicationDbContextModelContainer")
        {
        }
